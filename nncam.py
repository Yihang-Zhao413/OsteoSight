...
NNCAM_OPTION_AUTOEXPOSURE_PERCENT   = 0x4a       # auto exposure percent to average:
                                                   ...
                                                   #
NNCAM_OPTION_ANTI_SHUTTER_EFFECT    = 0x4b       # anti shutter effect: 1 => disable, 0 => disable; default: 0
...
NNCAM_OPTION_ADC                    = 0x08000000 # Analog-Digital Conversion:
                                                   #    get:
...
NNCAM_OPTION_AUTOEXP_EXPOTIME_STEP  = 0x60       # Auto exposure: time step (thousandths)
NNCAM_OPTION_AUTOEXP_GAIN_STEP      = 0x61       # Auto exposure: gain step (thousandths)
...
NNCAM_OPTION_PSEUDO_COLOR_ENABLE    = 0x65       # Pseudo: 1 => enable, 0 => disable
...
NNCAM_AUTOEXPO_STEP_DEF        = 1000     # auto exposure step: thousandths
NNCAM_AUTOEXPO_STEP_MIN        = 1        # auto exposure step: thousandths
NNCAM_AUTOEXPO_STEP_MAX        = 1000     # auto exposure step: thousandths
...
NNCAM_TEC_TARGET_DEF           = 100      # TEC target: 0.0 degrees Celsius
...
NNCAM_DYNAMIC_DEFECT_T1_MIN    = 10       # dynamic defect pixel correction, threshold, means: 1.0
NNCAM_DYNAMIC_DEFECT_T1_MAX    = 100      # means: 10.0
NNCAM_DYNAMIC_DEFECT_T1_DEF    = 13       # means: 1.3
NNCAM_DYNAMIC_DEFECT_T2_MIN    = 0        # dynamic defect pixel correction, value, means: 0.00
NNCAM_DYNAMIC_DEFECT_T2_MAX    = 100      # means: 1.00
...
class Nncam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 54.23882.20231115"""
        cls.__initlib()
