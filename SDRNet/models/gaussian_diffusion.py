...
from SDRNet.ldm.models.autoencoder import AutoencoderKLTorch
...
class GaussianDiffusion:
    ...
    #         with th.no_grad():
    #             z_y = first_stage_model.encode(y)
    #             print("[encode_first_stage] encoded z_y =", tuple(z_y.shape))
    #             out = z_y * self.scale_factor
    #         if not model_dtype == data_dtype:
    #             out = out.type(data_dtype)
    #         print("[encode_first_stage] final out =", tuple(out.shape))
    #         return out
