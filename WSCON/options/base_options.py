...
import torch
from WSCON import models
from WSCON import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='/opt/data/private/CUTGAN/datasets/mix_dataset/yap', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./WSCON/checkpoints', help='models are saved here')
        # model parameters
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='unaligned', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization | shuffle]')
